...
public class Login extends JFrame {
	 ...
	 */
	public Login() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/imagenes/Model1-120.png")));
		setResizable(false);
		setUndecorated(true);
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/imagenes/Model1-150.png")));
		...
		JLabel labelTitulo_1 = new JLabel("LA PAZ");
